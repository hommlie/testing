...
<head>
    ...
    <title>{{ trans('Hommlie - Admin') }}</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('storage/app/public/Adminassets/css/sweetalert2.min.css')}}">
    <link href="{{asset('storage/app/public/Adminassets/css/sweetalert2.min.css')}}" rel="stylesheet" type="text/css" />
...
<body class="sidebar-mini sidebar-open" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom  d-flex justify-content-between">
            ...
            <div>
            <a href="{{ url('/admin/gantt') }}" class="btn btn-outline-success rounded-pill mx-1 px-4">Gantt</a>
            <a href="{{ url('/admin/orders') }}" class="btn btn-outline-success rounded-pill mx-1 px-4">Orders</a>
            <a onclick="event.preventDefault(); document.getElementById('logoutform').submit();" class="btn btn-success text-light rounded-pill mx-1 px-4">Logout</a>
            </div>
