...
<div class="container card mt-5">
    ...
    <div class="">
        ...
        <form id="mediaForm" action="{{ route('admin.thoughtful-curations.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <label for="video_file" style="font-size: 0.9em;">Upload Video File <span class="text-success">(Only mp4, mov, avi, wmv formats are allowed)</span></label>
            ...
            <div class="form-group">
                <label for="thumbnail">Thumbnail <span class="text-success">(Only jpeg,png,jpg,gif formats are allowed)</span></label>
