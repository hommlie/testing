                                ...
                                <div class="px-3">
                                 ...
                                 <!--   <div class="form-group row">
                                    ...
                                    <div class="form-group row d-none">
                                      ...
                                      <div class="col-sm-10">
                                        <input type="text" class="form-control" id="sku" name="sku" placeholder="{{ trans('placeholder.sku') }}" value="NA">
                                        @if ($errors->has('sku'))
                            ...
                            <div class="card-body">
                                <div class="px-3">
                                  ...
                                  <div class="form-group row default_price" @if (old('is_variation') == 'on') style="display: none;" @endif>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="product_price" name="product_price" placeholder="{{ trans('Enter Actual Price') }}" value="{{old('product_price')}}">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="discounted_percentage" name="discounted_percentage" placeholder="{{ trans('Enter Discount %') }}" value="{{old('discounted_percentage')}}">
                                ...
                                <div class="form-group row default_price" @if (old('is_variation') == 'on') style="display: none;" @endif>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="discounted_price" name="discounted_price" placeholder="{{ trans('placeholder.discounted_price') }}" value="{{old('discounted_price')}}" readonly>
                                  ...
                                  <div class="form-group row default_price" @if (old('is_variation') == 'on') style="display: none;" @endif>
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="product_qty" name="product_qty" placeholder="{{ trans('Services Available') }}" value="{{old('product_qty')}}">
                                  ...
                                  <div class="row panel-body variation" @if (old('is_variation') != 'on') style="display: none;" @endif>
                                      ...
                                      <div class="col-sm-2 nopadding">
                                        <div class="form-group">
                                          <label for="variation_discount_percentage" class="col-form-label">Discount (%)</label>
                                            <input type="text" class="form-control" id="variation_discount_percentage" name="variation_discount_percentage[{{$i}}]" pattern="[0-9]+" value="{{old('variation_discount_percentage')[$loop->index]}}" placeholder="e.g., 5">
                                    ...
                                    @else
                                      ...
                                      <div class="col-sm-2 nopadding">
                                        <div class="form-group">
                                          <label for="variation_interval" class="col-form-label">Interval(AMC)</label>
                                            <input type="number" class="form-control discount-percentage" id="variation_interval" name="variation_interval[]"  value="{{old('variation_interval')}}" placeholder="In days">
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-sm-1 nopadding">
                                        <div class="form-group">
                                          <label for="price" class="col-form-label">Price</label>
                                            <input type="text" class="form-control" id="var_price" name="price[]" pattern="[0-9]+" value="{{old('price')}}" placeholder="Price">
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-sm-2 nopadding">
                                        <div class="form-group">
                                          <label for="discounted_variation_price" class="col-form-label">Discounted Price</label>
                                            <input type="text" class="form-control discounted-price" id="discounted_variation_price" name="discounted_variation_price[]" pattern="[0-9]+" placeholder="{{ trans('placeholder.discounted_price') }}">
                                        </div>
                                      </div>
