                            ...
                            <form action="{{ route('admin.timeslot.update',$data->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="name" placeholder="Day Schedule" id="title" value="{{ $data->name }}" class="form-control" />
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="col-lg-6">
                                        <label for="timeslot">Edit Start Time</label>
                                        <div class="col-lg-9">
                                            <input type="time" name="starttime" placeholder="e.g., 9AM-10AM"  id="timeslot" value="{{ $data->starttime }}" class="form-control" />
                                    ...
                                    <div class="col-lg-6">
                                        <label for="timeslot">Edit End Time</label>
                                        <div class="col-lg-9">
                                            <input type="time" name="endtime" placeholder="e.g., 9AM-10AM"  id="timeslot" value="{{ $data->endtime }}" class="form-control" />
