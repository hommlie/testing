                    ...
                    <div class="card-body">
                        ...
                        <div class="px-3">
                            <form class="form" method="post" action="{{ route('admin.banner.update') }}"
                                ...
                                @csrf
                                <div class="form-body">
                                    <input type="hidden" name="brand_id" id="brand_id" value="{{$data->id}}"
                                        class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" class="form-control" id="type">
                                            ...
                                            <option value="category" {{$data->type == "category" ? 'selected' : ''}}>
                                                {{ trans('labels.category') }}</option>
                                            <option value="product" {{$data->type == "product" ? 'selected' : ''}}>
                                                {{ trans('labels.product') }}</option>
                                        </select>
                                    </div>

                                    <div class="category gravity" @if($data->type != "category") style="display: none;"
                                    @endif>
                                        <div class="form-group">
                                            <label for="cat_id"
                                    ...
                                    <div class="product gravity" @if($data->type != "product") style="display: none;"
                                    @endif>
                                        <div class="form-group">
                                    ...
                                    <div class="product gravity">
                                        <div class="form-group">
                                            ...
                                            <input type="url" class="form-control" name="link"
                                                placeholder="https://youtube.com" required value="{{$data->link}}">
                                        </div>
                                    </div>
                                    ...
                                    <img src='{!! asset("storage/app/public/images/banner/" . $data->image) !!}'
                                        class='media-object round-media height-50' style="height:80px">
                                    <br><br>
                                </div>
