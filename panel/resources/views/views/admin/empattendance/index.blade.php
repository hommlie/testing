                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form action="{{ route('admin.empattendance.getLoginData') }}" method="post"
                                class="float-right">
                                @csrf
                                <div class="d-flex">
                                    ...
                                    <input type="submit" name="submit" class="btn btn-raised btn-primary" id=""
                                        style="height: 40px;">
                                </div>
                            </form>
                            ...
                            <div class="card-block card-dashboard" id="table-display">
                                <div id="filter_buttons" class="d-flex align-items-center">
                                    ...
                                    <button class="btn btn-sm btn-outline-success round-pill mx-2" id="filter_custom">Custom
                                        Date</button>
                                    <a href="empattendance" class="btn btn-sm btn-outline-success round-pill mx-2"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($data as $row)
                                            <tr>
                                                ...
                                                <td> {{ $row->distance_travelled ? number_format($row->distance_travelled / 1000, 2) . ' km' : 'NULL' }}
                                                </td>
