                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        ...
                        <div class="card-body p-3 col-lg-6 mx-auto">
                            <form action="{{ route('admin.inventory.update',$data->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <div class="row col-lg-12 mb-3">
                                        ...
                                        <div class="col-lg-8">
                                            <select name="category" id="category" class="form-control">
                                                ...
                                                <option value="{{ $category_type->name }}" {{ $data->category == $category_type->name ? 'selected' : ''  }}>{{ $category_type->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row col-lg-12 mb-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="subCategory" placeholder="e.g., Enter subCategory" id="subCategory" value="{{ $data->subCategory }}" class="form-control" />
                                    ...
                                    <div class="row col-lg-12 mb-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number" step="any" name="quantity" placeholder="e.g., Enter quantity" id="quantity" value="{{ $data->quantity }}" class="form-control" />
                                    ...
                                    <div class="row col-lg-12 mb-3">
                                        ...
                                        <div class="col-lg-8">
                                            <select name="type" id="type" class="form-control">
                                                ...
                                                <option value="{{ $quantity_type->shortcut }}"  {{ $data->type == $quantity_type->shortcut ? 'selected' : ''  }}>{{ $quantity_type->name }}</option>
                                                @endforeach
                                            </select>
                                            @if ($errors->has('type'))
                                    ...
                                    <div class="row col-lg-12 mb-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number" step="any" name="price" placeholder="e.g., Enter price" id="price" value="{{ $data->price }}" class="form-control" />
                                            @if ($errors->has('price'))
                                    ...
                                    <div class="row col-lg-12 mb-3">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" step="any" name="vendor" placeholder="e.g., Enter vendor" id="vendor" value="{{ $data->vendor }}" class="form-control" />
