            ...
            <div class="col-12">
                <div class="card">                       
                    <div class="card-header">
                        <h4 class="card-title">{{ trans('Assigned Inventory TO Employees') }}</h4>
                    ...
                    <div class="card-body collapse show">
                        <div class="card-block card-dashboard" id="table-display">
                            <div id="filter_buttons" class="d-flex align-items-center">
                                ...
                                <a href="./assigned_inventory_history" class="btn btn-sm btn-outline-success round-pill mx-2" id="filter_reset">Reset Filter</a>
                            </div>
