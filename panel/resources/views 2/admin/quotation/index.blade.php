                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        <div class="card-header">
                            <h4 class="card-title">{{ trans('Quotations') }}</h4>
                            <a href="{{route('admin.quotation.add')}}" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                                {{ trans('Add Quotation') }}
                            </a>
                        </div>
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                <div id="filter_buttons" class="d-flex align-items-center">
                                    ...
                                    <a href="quotation" class="btn btn-sm btn-outline-success round-pill mx-2" id="filter_reset">Reset Filter</a>
                                </div>
                                ...
                                <br>
                                    @include('admin.quotation.quotationtable')
                            </div>
                        </div>
                    </div>
                </div>
