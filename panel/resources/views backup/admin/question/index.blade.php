            ...
            <div class="col-12">
                <div class="card">                       
                    <div class="card-header">
                        <h4 class="card-title">{{ trans('Questions') }}</h4>
                        <a href="{{ route('admin.question.add') }}" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                            {{ trans('Add Questions') }}
                        </a>
                    </div>
                    ...
                    <div class="card-body collapse show">
                        <div class="card-block card-dashboard" id="table-display">
                            <div id="filter_buttons" class="d-flex align-items-center">
                                    ...
                                    <a href="question" class="btn btn-sm btn-outline-success round-pill mx-2" id="filter_reset">Reset Filter</a>
                                </div>
                                ...
                                <br>
                            @include('admin.question.questiontable')
                        </div>
                    </div>
                </div>
            </div>
