                ...
                <td id="tdstatus{{$row->id}}">
                    ...
                    @else
                        <span class="btn btn-raised btn-outline-danger round btn-min-width mr-1 mb-1 changeStatus"
                            data-status="1" data-id="{{$row->id}}">
                            <span class="red-text">{{ trans('labels.deactive') }}</span>
                        </span>
                    @endif
                </td>
                <td>
                    <a href="{{URL::to('admin/product/show/' . $row->id)}}" class="success p-0 edit"
                    ...
                    <a href="javascript:void(0);" class="danger p-0" data-original-title="{{ trans('labels.delete') }}"
                        ...
                        onclick="do_delete('{{$row->id}}','{{route('admin.products.delete')}}','{{ trans('labels.delete_product') }}','{{ trans('labels.delete') }}')">
