                            ...
                            <form action="{{ route('admin.testimonials.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" name="name" placeholder="e.g., John Doe" id="name" value="{{ old('name') }}" class="form-control" />
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" name="location" placeholder="e.g.,Bangalore " id="location" value="{{ old('location') }}" class="form-control" />
                                    ...
                                    <div class="col-lg-12">
                                        <label for="location">Customer Feedack</label>
                                        <textarea name="feedback" rows="5" class="form-control" required id="feedback" placeholder="Write feedback Here.."></textarea>
