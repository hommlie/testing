                    ...
                    <div id="invoice-template" class="card-block">
                        ...
                        <div id="invoice-company-details" class="row">
                            <div class="col-6 text-left">
                                ...
                                <img src="{{ asset('storage/app/public/Adminassets/img/sidebar-bg/hommlie-logo.png') }}" alt="company logo" class="mb-2" width="70">
                                ...
                                <div class="table-responsive col-sm-12">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                            <tr>
                                                <td><img class="media-object round-media height-50" src="{{$row->image_url}}" alt="Generic placeholder image" style="width: 70px;" /></td>
                                                    ...
                                                    <div class="btn-group">
                                                        @if ($row->status != 4)
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @if ($row->status == 1)
                                                                    <button class="dropdown-item changeStatus active" data-id="{{$row->id}}"  data-status="1">Order placed</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="2">Confirmed</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="3">Order shipped</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="4">Delivered</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="5">Cancelled</button>
                                                                @endif
                                                                @if ($row->status == 2)
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="1">Order placed</button>
                                                                    <button class="dropdown-item changeStatus active" data-id="{{$row->id}}"  data-status="2">Confirmed</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="3">Order shipped</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="4">Delivered</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="5">Cancelled</button>
                                                                @endif
                                                                @if ($row->status == 3)
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="1">Order placed</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="2">Confirmed</button>
                                                                    <button class="dropdown-item changeStatus active" data-id="{{$row->id}}"  data-status="3">Order shipped</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="4">Delivered</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="5">Cancelled</button>
                                                                @endif
                                                                @if ($row->status == 4)
                                                                    ...
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="2">Confirmed</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="3">Order shipped</button>
                                                                    <button class="dropdown-item changeStatus active"  data-id="{{$row->id}}" data-status="4">Delivered</button>
                                                                    <button class="dropdown-item changeStatus"  data-id="{{$row->id}}" data-status="5">Cancelled</button>
                                                                @endif
                                                            </ul>
                                                            @if ($row->status == 5)
                                                ...
                                                @endif
                                                <td {{ $row->order_status==4 ? 'style="text-decoration: line-through;"' : '' }}>₹{{$row->price+$row->tax}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td>Sub Total</td>
                                                    <td class="text-right">₹{{$order_info->subtotal}}</td>
                                                </tr>
                                                <tr>
                                                    <td>TAX</td>
                                                    <td class="text-right">₹{{$order_info->tax}}</td>
                                                </tr>
                                                
                                                <tr>
                                                    <td class="text-bold-800 font-weight-bold">Total</td>
                                                    <td class="text-bold-800 text-right font-weight-bold">₹{{$order_info->subtotal +  $order_info->tax}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
