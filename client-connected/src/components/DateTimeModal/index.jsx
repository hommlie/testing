    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* Centered Modal */}
          <motion.div
            className="relative bg-white w-[90%] md:w-[500px] max-w-[90vw] max-h-[85vh] overflow-y-auto p-6 md:p-8 md:px-12 rounded-2xl shadow-lg z-30 space-y-4 scrollbar-hide"
            ...
            <div className='flex flex-col gap-3'>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-3 gap-3 w-full px-2">
                {times.map((time, index) => (
                  <div
                    key={index}
                    className={`h-[40px] flex justify-center items-center rounded border cursor-pointer text-sm text-center transition-all duration-150 ${selectedTime === time
