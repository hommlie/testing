                        ...
                        <div className="px-4 md:px-0 flex flex-col md:flex-row gap-4 justify-between pb-4 mb-4 mt-10" style={{borderBottom: "1px solid #E3E3E3"}}>
                            <div className="space-y-1 sm:space-y-3 lg:space-y-4">
                                ...
                                <div className="flex items-center mb-2">
                                    <MdStars className="text-base md:text-2xl" color="#FF3269" />
                                    <p className="text-base md:text-xl font-normal ml-2">{reviewData?.avg_ratting} ({reviewData?.total} reviews)</p>
                                </div>
                                <p className="flex items-center">
                                    <span className="text-xl md:text-3xl font-bold">
                                        ₹{selectedVariation ? selectedVariation.discounted_variation_price : prodData?.discounted_price}
                                    </span>
                                    <span className="line-through text-lg md:text-2xl sm:text-3xl font-light ml-4" style={{color: "#545454"}}>
                                        ₹{selectedVariation ? selectedVariation.price : prodData?.product_price}
                                    </span>
                                    {prodData?.est_shipping_days != 0 ?
                                        <span className="flex flex-row items-center gap-2 text-base sm:text-2xl font-normal ml-8" style={{color: "#545454"}}>
                                            <CiClock1 />
