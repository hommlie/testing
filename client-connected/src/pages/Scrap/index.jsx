  ...
  <div class="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 pt-10 md:pt-0">
    ...
    >
      ...
      >
        <a
          href="tel:6363865658"
          class="inline-flex items-center justify-center w-full sm:w-auto h-12 px-6 rounded-md font-semibold bg-[#0463ac] hover:bg-[#52852d] active:bg-emerald-800 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"
        >
          Contact me
        </a>
        ...
        <a
          href="/business"
          class="inline-flex items-center justify-center w-full sm:w-auto h-12 px-6 rounded-md font-semibold border border-white/80 text-white backdrop-blur-[2px] bg-white/0 hover:bg-[#52852d] hover:text-white transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70"
        >
          For Business
        </a>
      </div>
      ...
      >
        ...
        <div className="flex justify-end">
          <button
            ...
            className="rounded-md bg-[#0463ac] hover:bg-[#52852d] px-5 py-2 text-sm font-medium text-white shadow-md hover:shadow-lg transition focus:outline-none focus:ring-2 focus:ring-emerald-500"
          >
            More
          </button>
        </div>
      ...
      <section className="mx-auto max-w-[1250px] px-4 sm:px-6 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="mt-5 sm:mt-0">
            ...
            <button className="mt-5 inline-flex items-center gap-2 rounded-md bg-[#0463ac] hover:bg-[#52852d] px-5 py-2.5 text-white font-medium">
              Learn More <span aria-hidden>→</span>
            </button>
          </div>
        </div>
