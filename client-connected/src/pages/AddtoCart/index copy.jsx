      ...
      <div className="relative w-full max-w-5xl my-6 md:my-16 space-y-6 px-4">
        ...
        {isLoading && cart.length === 0 ? (
          ...
          cart?.map((pd, index) => (
            <div
              key={index}
              className="bg-white rounded-lg shadow p-4 md:p-6 flex items-center"
            >
              {pd.image_url && (
                <div
                  onClick={() =>
                    navigate(`${config.VITE_BASE_URL}/product/${pd.slug}`)
                  }
                >
                  <img
                    src={pd.image_url}
              ...
              <div className="h-32 flex flex-col justify-between items-end">
                <div
                ...
                >
                  ...
                  <span className="text-center w-8 h-8 leading-8">
                    {pd?.qty}
                  </span>
                  <button
                    onClick={() => handleQtyUpdate(pd?.id, pd?.qty + 1)}
              ...
              <form className="space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    id="saveCard"
                    name="saveCard"
                    className="h-4 w-4 text-[#249370] focus:ring-green-500 border-gray-300 rounded"
                  />
                  <label
                    htmlFor="saveCard"
                    className="ml-2 block text-sm text-gray-700"
                  >
                    Save this card information to my account and make faster
                    payments.
                  </label>
                </div>
              </form>
        ...
        <section className="bg-white rounded-lg shadow p-6">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-4 md:mb-0 md:mr-4">
              ...
              <button
                className="text-[#249370] text-semibold"
