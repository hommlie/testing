                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        <div class="card-header bg-light">
                            <h4 class="card-title">{{ trans('Inward Inventory') }}</h4>
                        ...
                        <div class="card-body p-3 col-lg-6 mx-auto">
                            <form action="{{ route('admin.inventory.InwardUpdate',$data->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row mb-3 col-lg-12">
                                        <label class="col-lg-4" for="outward">Enter Quantity to Inward</label>
                                        <div class="col-lg-8">
                                            <input type="number" step="any" name="inward" placeholder="e.g., Enter Consumed quantity" id="outward" value="" class="form-control" />
                                            @if ($errors->has('inward'))
                                            <span class="text-danger">{{ $errors->first('inward') }}</span>
                                            @endif
                                        </div>
                                    </div>
