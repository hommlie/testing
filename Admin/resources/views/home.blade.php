    ...
    <div class="row p-3">
        <div class="col-lg-3 my-2" >
            <a href="{{ url('admin/customers') }}">
                <div class="d-flex justify-content-between p-3 bg-white rounded mx-2" style="box-shadow: rgba(17, 17, 26, 0.05) 0px 1px 0px, rgba(17, 17, 26, 0.1) 0px 0px 8px;border-bottom:3px solid green">
                    <div>
